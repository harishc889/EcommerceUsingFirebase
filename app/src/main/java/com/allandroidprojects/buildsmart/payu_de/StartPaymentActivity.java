...
public class StartPaymentActivity extends AppCompatActivity {
    ...
    String TAG ="mainActivity", txnid ="txt12346", amount ="10", phone ="9756423780",
            prodname ="Kuch bhi", firstname ="Harish", email ="harshitc889@gmail.com",
            merchantId ="12345", merchantkey="Wioja3s3";  //   first test key only
