package com.allandroidprojects.buildsmart.utility;
...
public class ImageUrlUtils {
    ...
    static ArrayList<String> cartListpName = new ArrayList<>();
    static ArrayList<String> cartListpPrice = new ArrayList<>();

    public static String[] getMoreDesc()
    {

        int size= HomeActivity.getInstanc().moreDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().moreDetails.get(i).getDescription();}
        return names;

    }
    public static String[] getMobilesDesc()
    {

        int size= HomeActivity.getInstanc().mobilesDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().mobilesDetails.get(i).getDescription();}
        return names;

    }
    public static String[] getOffersDesc()
    {

        int size= HomeActivity.getInstanc().offerDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().offerDetails.get(i).getDescription();}
        return names;

    }
    public static String[] getLifestyleDesc()
    {

        int size= HomeActivity.getInstanc().lifestyleDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().lifestyleDetails.get(i).getDescription();}
        return names;

    }
    public static String[] getBooksDesc()
    {

        int size= HomeActivity.getInstanc().booksDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().booksDetails.get(i).getDescription();}
        return names;

    }
    public static String[] getLaptopsDesc()
    {

        int size= HomeActivity.getInstanc().laptopsDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().laptopsDetails.get(i).getDescription();}
        return names;
    ...
    public static String[] getMoreName()
    {

        int size= HomeActivity.getInstanc().moreDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().moreDetails.get(i).getName();}
        return names;

    }
    public static String[] getMorePrice()
    {
        int size= HomeActivity.getInstanc().booksDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().booksDetails.get(i).getPrice();}
        return names;


    }
    public static String[] getBooksPrice()
    {
        int size= HomeActivity.getInstanc().booksDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
    ...
    public static String[] getBooksName()
    {
        ...
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().booksDetails.get(i).getName();}
        return names;

    }


    public static String[] getMobilesName()
    {

        int size= HomeActivity.getInstanc().mobilesDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().mobilesDetails.get(i).getName();}
        return names;

    }
    public static String[] getMobilesPrice()
    {
        int size= HomeActivity.getInstanc().mobilesDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().mobilesDetails.get(i).getPrice();}
        return names;


    }

    public static String[] getLifestyleName()
    {

        int size= HomeActivity.getInstanc().lifestyleDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().lifestyleDetails.get(i).getName();}
        return names;

    }
    public static String[] getLifestylePrice()
    {
        int size= HomeActivity.getInstanc().lifestyleDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().lifestyleDetails.get(i).getPrice();}
        return names;


    }

    public static String[] getLaptopsName()
    {

        int size= HomeActivity.getInstanc().laptopsDetails.size();
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().laptopsDetails.get(i).getName();}
        return names;
    ...
    public static String[] getLaptopsPrice()
    {
        ...
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().laptopsDetails.get(i).getPrice();}
        return names;
    ...
    public static String[] getOffersName()
    {
        ...
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().offerDetails.get(i).getName();}
        return names;
    ...
    public static String[] getOffersPrice()
    {
        ...
        String []names = new String [size];
        for(int i=0;i<size;i++){
            names[i] =HomeActivity.getInstanc().offerDetails.get(i).getPrice();}
        return names;
    ...
    public static String[] getImageUrls() {
        ...
        for(int i=0;i<size;i++){
            urls[i] =HomeActivity.getInstanc().moreDetails.get(i).getDownloadurl();}
...
//        };
    ...
    public static String[] getOffersUrls() {
        ...
        String []urls = new String [size];
        for(int i=0;i<size;i++){
            urls[i] =HomeActivity.getInstanc().offerDetails.get(i).getDownloadurl();}
...
//                "https://static.pexels.com/photos/211048/pexels-photo-211048-medium.jpeg",
    ...
    public static String[] getMobilesUrls() {
        int size= HomeActivity.getInstanc().mobilesDetails.size();
        String []urls = new String [size];
        for(int i=0;i<size;i++){
            urls[i] =HomeActivity.getInstanc().mobilesDetails.get(i).getDownloadurl();}
//                "https://static.pexels.com/photos/1778/numbers-time-watch-white-medium.jpg",
...
//                "https://static.pexels.com/photos/106936/pexels-photo-106936-medium.jpeg"
    ...
    public static String[] getLaptopsUrls() {
        ...
        String []urls = new String [size];
        for(int i=0;i<size;i++){
            urls[i] =HomeActivity.getInstanc().laptopsDetails.get(i).getDownloadurl();}
...
//                "https://static.pexels.com/photos/114907/pexels-photo-114907-medium.jpeg"
    ...
    public static String[] getLifeStyleUrls() {
        ...
        String []urls = new String [size];
        for(int i=0;i<size;i++){
            urls[i] =HomeActivity.getInstanc().lifestyleDetails.get(i).getDownloadurl();}
...
//                "https://static.pexels.com/photos/193355/pexels-photo-193355-medium.jpeg",
    ...
    public static String[] getBooksUrls() {
        ...
        String []urls = new String [size];
        for(int i=0;i<size;i++){
            urls[i] =HomeActivity.getInstanc().booksDetails.get(i).getDownloadurl();}
//                "https://static.pexels.com/photos/67442/pexels-photo-67442-medium.jpeg",
//                "https://static.pexels.com/photos/159494/book-glasses-read-study-159494-medium.jpeg",
...
//                "https://static.pexels.com/photos/68562/pexels-photo-68562-medium.jpeg",
    ...
    // Methods for Cart
    public int addCartListImageUri(String wishlistImageUri,String name,String price,int total) {
        this.cartListImageUri.add(0,wishlistImageUri);
        this.cartListpName.add(0,name);
        this.cartListpPrice.add(0,price);
        total=total+Integer.parseInt(price);
        return total;
    }


    public int removeCartListImageUri(int position,int total) {
        this.cartListImageUri.remove(position);
        total=total-Integer.parseInt(cartListpPrice.get(position));
        return total;
    }

    public ArrayList<String> getCartListImageUri(){ return this.cartListImageUri; }

    public ArrayList<String> getppriceCartList(){ return this.cartListpName; }

    public ArrayList<String> getpnameCartList(){ return this.cartListpPrice; }
